...
public class Forget_Password extends AppCompatActivity {
        ...
        contnue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(phone.getText().toString())){
                    Toast.makeText(Forget_Password.this, "Phone Number is required", Toast.LENGTH_SHORT).show();
                }
                else {
                    getData(code.concat(phone.getText().toString().trim()));
                }
            }
        });
    }
    private void getData(final String Phone) {
        ...
        CustomRequest jsonRequest = new CustomRequest(Request.Method.POST, Constant.Base_url_forget,params, new Response.Listener<JSONObject>() {
            @Override
